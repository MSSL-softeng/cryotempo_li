...
copdem = Dem("cop_dem_90m_grn_zarr")
cop_dem_elevs = copdem.interp_dem(latitudes, longitudes, method="linear", xy_is_latlon=True)

elevation_diffs = arctic_dem_elevs - cop_dem_elevs

n_points = latitudes.shape[0]

# Create and open a new netCDF file for writing
output_filename = "/tmp/greenland_zarr_dem_diffs.nc"
